...
class LoginController extends Controller
{
    ...
    public function mostrarFormularioLoginDAR() // Sustituye XYZ por tus iniciales
    {
        return view('auth.login');
    }

    // Realizar el inicio de sesión autenticada
    public function loginDAR(Request $request) // Sustituye XYZ por tus iniciales
    {
    ...
    public function logoutDAR(Request $request) // Sustituye XYZ por tus iniciales
    {
        Auth::logout();
